...
class AdminBV_Control extends CI_Controller {
	...
	public function bv_update()
	{
		$our_prod_amt=$this->input->post('our_prod_amt');
		$our_prod_bv=$this->input->post('our_prod_bv');
		$other_prod_amt=$this->input->post('other_prod_amt');
		$other_prod_bv=$this->input->post('other_prod_bv');
		$data=$this->AdminBv_Modal->bv_update_mdl($our_prod_amt,$our_prod_bv,$other_prod_amt,$other_prod_bv);
		echo json_encode($data);
	}
	
	
	public function bv_fetch()
	{
		$data=$this->AdminBv_Modal->bv_fetch_mdl();
		echo json_encode($data);
	}
