        ...
        <div class="page-body">
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3>View Mark Sheet</h3>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>"> <i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">Mark Sheet</li>
                    <li class="breadcrumb-item active"> View Mark Sheet </li>
                  </ol>
                </div>
              </div>
            </div>
									...
									<tbody id="tbody_city">
										...
										?>
											<tr>
												...
												<td>Maths: <?php echo $student_list[$i]->maths_marks; ?></br>
												Physics; <?php echo $student_list[$i]->phy_marks; ?></br>
												Chemistry: <?php echo $student_list[$i]->chem_marks; ?></br>
												Hindi: <?php echo $student_list[$i]->hindi_marks; ?></br>
												English: <?php echo $student_list[$i]->english_marks; ?></td><!---->
												<td>500</td>
