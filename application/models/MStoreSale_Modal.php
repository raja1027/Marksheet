...
class MStoreSale_Modal extends CI_Model
{
		
    function fetch_member_wallet_details_mdl($username)
    {		
		$query = $this->db->query("CALL fetch_member_wallet_detail_by_userid('".$username."')");
        return $query->result();
    }
		
		
    function sale_save_on_member_wallet_mdl($trans_1_id,$ewalletAmount,$voucher_date,$member_panel_id,$tran_status,$user_type,$user_id)
    {		
		$query = $this->db->query("CALL save_sale_on_member_wallet('".$trans_1_id."','".$ewalletAmount."','".$voucher_date."','".$member_panel_id."','".$tran_status."','".$user_type."','".$user_id."')");
	...
	function save_sale_mdl($user_id,$trans_category,$voucher_number,$mat_center,$sale_party,$srch_sale_party,$mobile_no,$voucher_date,$tax_region,$voucher_prefix,$voucher_last_no,$indent_no,$indent_date,$tot_all_discount_amt,$txt_address,$txt_narration,$save_sale_mdl)
    {		
		$query = $this->db->query("CALL save_trans1('".$user_id."','".$trans_category."','".$voucher_number."','".$mat_center."','".$sale_party."','".$srch_sale_party."','".$mobile_no."','".$voucher_date."','".$tax_region."','".$voucher_prefix."','".$voucher_last_no."','".$indent_no."','".$indent_date."','".$tot_all_discount_amt."','".$txt_address."','".$txt_narration."','".$save_sale_mdl."')");
    ...
    {		
		$query = $this->db->query("CALL save_order2('".$user_id."','".$sale_party."','".$order1_id."','".$probarcode."','".$proid."','".$proqty."','".$proprice."','".$proamt."')");
